...
class Preferences {
  ...
  Future<Preferences> fetch() async {
    ...
    try {
      this.lastUpdated = DateTime.tryParse(prefs.getString('${prefix}_updated'));
    } catch (e) {
